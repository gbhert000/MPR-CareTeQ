    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            @if ($clearFilterButton && count($filters) > 0)
                <div class="px-4 py-2 bg-gray-0 text-right flex justify-end">
                    <button type="button" wire:click="clearFilters" onclick="document.querySelector('#filter-form').reset()" class="btn btn-link btn-filter-form">
                        <span class="mr-2">
