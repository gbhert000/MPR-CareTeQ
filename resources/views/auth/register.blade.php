                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-outline-dark" type="button" id="showPasswordRegister" name="showPassword"><i
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button class="btn btn-outline-dark" type="button" id="showConfirmPasswordregister" name="showConfirmPassword"><i
                                                    class="fa fa-solid fa-eye"></i></button>
