    ...
    <div role="document" class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-header row d-flex justify-content-between mx-1 mx-sm-3 mb-0 pb-0 border-0">
                <div class=" col tabs active" id="tab01">
                        ...
                        <div class="row">
                            <div class="col-sm-2 ">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control no-bg" name="CODE" id="CODE" disabled>
                                </div>
                            </div>
                            <div class="col-md">
                                ...
                                <div class="row">
                                    <div class="col pr-1-cust">
                                        ...
                                        <input type="text"  class="form-control" name="U_LASTNAME" id="U_LASTNAME" readonly>
                                    ...
                                    <div class="pr-1-cust col">
                                        <label>Sex</label>
                                        <select name="updatesex" id="regSex" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="w-100"></div>
                                    <div class="col">
                                        <label for="contactType0">Contact Type</label>
                                        <select name="contactType0" id="contactType0" class="form-control" >
                                        <option value="" selected></option> 
                                            <option value="HOME">Home {{'(Telephone)'}}</option>
                                            <option value="WORK">Work </option>
                                            <option value="PERSONAL">Personal {{'(Mobile)'}} </option>
                                        </select>
                                        <input type="text" class="hidden" id="hideContact0" name="hideContact0">
                                    </div>
                                    
                                
                                    <div class="col">
                                        <label>Contact Number</label>
                                        <input type="text"class="form-control" name="contact0" id="contact0" >
                                    </div>
                                    <div class="col cols1">
            ...
            <!-- START MODAL FOOTER -->
                <div class="modal-footer">
                    <button type="button"  class="btn btn-secondary" data-bs-dismiss="modal" id="closeReset"  onclick="resetInput()">Close</button>
